   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" placeholder="Enter your full address" class="box" required>
         </div>
         <div class="inputBox">
            <span>House Number :</span>
            <input type="text" name="street" placeholder="e.g. 69" class="box" required>
         </div>
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="e.g. Bekasi" class="box" required>
         </div>
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" placeholder="e.g. Jawa Barat" class="box" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
